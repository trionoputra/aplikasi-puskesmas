Public Class CetakLaporanObatHampirAbis
    Private Sub CetakLaporanObatHampirAbis_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub
    Private Sub cetak()
        Dim model As New ObatModel
        Dim tbReport As DataTable = model.getCetakObatHampirAbis()

        If (tbReport.Rows.Count <> 0) Then
            Dim objRpt As New RptObatHampirAbis
