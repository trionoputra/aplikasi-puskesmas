...
Public Class RptResepHarian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.RptResepHarian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptResepHarian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptResepHarian = New RptResepHarian()
        rpt.Site = Me.Site
        Return rpt
    End Function
