...
Public Class RptPasienBaru
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.RptPasienBaru.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPasienBaru
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPasienBaru = New RptPasienBaru()
        rpt.Site = Me.Site
        Return rpt
    End Function
