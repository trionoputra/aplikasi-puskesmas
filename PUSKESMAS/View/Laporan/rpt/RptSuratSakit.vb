...
Public Class RptSuratSakit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.RptSuratSakit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSuratSakit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSuratSakit = New RptSuratSakit()
        rpt.Site = Me.Site
        Return rpt
    End Function
