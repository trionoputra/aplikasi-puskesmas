...
Public Class RptObatExpired
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.RptObatExpired.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptObatExpired
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptObatExpired = New RptObatExpired()
        rpt.Site = Me.Site
        Return rpt
    End Function
