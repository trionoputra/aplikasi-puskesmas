...
Public Class RptKunjunganPasien
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.RptKunjunganPasien.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptKunjunganPasien
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptKunjunganPasien = New RptKunjunganPasien()
        rpt.Site = Me.Site
        Return rpt
    End Function
