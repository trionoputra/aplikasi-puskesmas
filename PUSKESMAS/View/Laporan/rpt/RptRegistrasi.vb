...
Public Class RptRegistrasi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.RptRegistrasi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRegistrasi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRegistrasi = New RptRegistrasi()
        rpt.Site = Me.Site
        Return rpt
    End Function
