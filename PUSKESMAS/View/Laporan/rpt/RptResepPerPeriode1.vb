...
Public Class RptResepPerPeriode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.RptResepPerPeriode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptResepPerPeriode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptResepPerPeriode = New RptResepPerPeriode()
        rpt.Site = Me.Site
        Return rpt
    End Function
