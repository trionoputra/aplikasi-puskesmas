...
Public Class RptObatHampirAbis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.RptObatHampirAbis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptObatHampirAbis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptObatHampirAbis = New RptObatHampirAbis()
        rpt.Site = Me.Site
        Return rpt
    End Function
