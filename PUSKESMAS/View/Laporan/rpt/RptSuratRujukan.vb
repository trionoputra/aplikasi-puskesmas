...
Public Class RptSuratRujukan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.RptSuratRujukan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSuratRujukan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSuratRujukan = New RptSuratRujukan()
        rpt.Site = Me.Site
        Return rpt
    End Function
