...
Public Class RptKartuPengunjung
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.RptKartuPengunjung.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptKartuPengunjung
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptKartuPengunjung = New RptKartuPengunjung()
        rpt.Site = Me.Site
        Return rpt
    End Function
