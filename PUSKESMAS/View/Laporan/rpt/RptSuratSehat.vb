...
Public Class RptSuratSehat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.RptSuratSehat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSuratSehat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSuratSehat = New RptSuratSehat()
        rpt.Site = Me.Site
        Return rpt
    End Function
