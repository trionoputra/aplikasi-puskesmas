...
Public Class KartuPengunjung
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PUSKESMAS.KartuPengunjung.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedKartuPengunjung
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As KartuPengunjung = New KartuPengunjung()
        rpt.Site = Me.Site
        Return rpt
    End Function
