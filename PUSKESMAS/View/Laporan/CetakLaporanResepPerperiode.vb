Public Class CetakLaporanResepPerperiode
    Private Sub CetakLaporanResepPerperiode_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub
    Private Sub cetak()
        Dim model As New ResepModel
        Dim tbReport As DataTable = model.getCetakLaporanPeriode(dtfrom.Value.Date, dtto.Value.Date)
        If (tbReport.Rows.Count <> 0) Then
            Dim objRpt As New RptResepPerPeriode
