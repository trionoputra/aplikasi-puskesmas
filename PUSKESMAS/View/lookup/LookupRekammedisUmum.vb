Public Class LookupRekammedisUmum
    Public tipe As String
    Private Sub LookupRekammedisUmum_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        fillGrid("")
    End Sub
    Private Sub fillGrid(ByVal keyword As String)
        Dim model As New RekamMedisUmumModel
        DataGridView1.DataSource = model.getRekammedisBy(keyword, tipe)
    End Sub
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        If (e.RowIndex <> -1) Then
            ...
            _diagnosa = DataGridView1.Rows(e.RowIndex).Cells(7).Value
