Public Class LookupKK
   
    Private Sub LookupKK_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        fillGrid("")
    End Sub
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        If (e.RowIndex <> -1) Then
            _kodekk = DataGridView1.Rows(e.RowIndex).Cells(0).Value
            _namakk = DataGridView1.Rows(e.RowIndex).Cells(1).Value
